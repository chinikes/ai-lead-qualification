...
const FONTS_URL = "https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&family=DM+Sans:wght@400;500;600;700&display=swap";
...
export default function Dashboard() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#0A0B0E", color: "#fff", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <style>{`@import url('${FONTS_URL}'); ::-webkit-scrollbar{width:3px} ::-webkit-scrollbar-thumb{background:rgba(255,255,255,0.06);border-radius:2px} *{box-sizing:border-box;margin:0;padding:0} @keyframes fadeIn{from{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:translateY(0)}}`}</style>
